        ...
        <div className="w-[90%] md:h-[80vh] h-screen mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-4 py-4">
            ...
            <div className="flex-1 flex justify-start items-center px-4">
                <div className="max-w-3xl space-y-6">
                    <Fade direction="up" delay={0.1} className="space-y-4 ">
                        <h1 className="text-3xl md:text-4xl xl:text-5xl YekanBlack"> تجربه دیجیتال بی‌نظیر با وبسایت حرفه‌ای </h1>
                    ...
                    <Fade direction="up" delay={0.3} className="flex flex-wrap gap-4 mt-6">
